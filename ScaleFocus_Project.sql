USE [master]
GO
/****** Object:  Database [ScaleFocus_Project]    Script Date: 13.7.2021 г. 10:15:10 ******/
...
GO
/****** Object:  Table [dbo].[Project]    Script Date: 13.7.2021 г. 10:15:10 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ProjectTeam]    Script Date: 13.7.2021 г. 10:15:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Task]    Script Date: 13.7.2021 г. 10:15:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Team]    Script Date: 13.7.2021 г. 10:15:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[User]    Script Date: 13.7.2021 г. 10:15:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserTeam]    Script Date: 13.7.2021 г. 10:15:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[WorkLog]    Script Date: 13.7.2021 г. 10:15:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Project] ([Id], [Title], [Description], [DateOfCreation], [IdCreator], [DateLastChange], [IdLastChange]) VALUES (2, N'project2', N'description2', CAST(N'2021-07-08T13:58:12.700' AS DateTime), 1, CAST(N'2021-07-12T15:46:58.900' AS DateTime), 3)
GO
INSERT [dbo].[Project] ([Id], [Title], [Description], [DateOfCreation], [IdCreator], [DateLastChange], [IdLastChange]) VALUES (3, N'Project3', N'Description3', CAST(N'2021-07-09T09:39:22.430' AS DateTime), 4, CAST(N'2021-07-09T09:39:22.430' AS DateTime), 3)
GO
INSERT [dbo].[Project] ([Id], [Title], [Description], [DateOfCreation], [IdCreator], [DateLastChange], [IdLastChange]) VALUES (4, N'project4', N'description4', CAST(N'2021-07-13T09:23:39.853' AS DateTime), 5, CAST(N'2021-07-13T09:23:39.853' AS DateTime), 5)
GO
...
GO
INSERT [dbo].[Task] ([Id], [IdOfProject], [IdOfAssignee], [Title], [Description], [TaskStatus], [DateOfCreation], [IdOfCreator], [DateLastChange], [IdLastChange]) VALUES (3, 1, 3, N'Task2', N'Description2', N'Completed', CAST(N'2021-07-09T09:56:23.023' AS DateTime), 1, CAST(N'2021-07-09T09:56:23.023' AS DateTime), 3)
GO
...
GO
INSERT [dbo].[Team] ([Id], [Title], [DateOfCreation], [IdCreator], [DateLastChange], [IdLastChange]) VALUES (2, N'team2', CAST(N'2021-07-08T13:45:20.513' AS DateTime), 1, CAST(N'2021-07-12T15:43:47.930' AS DateTime), 3)
GO
...
GO
INSERT [dbo].[Team] ([Id], [Title], [DateOfCreation], [IdCreator], [DateLastChange], [IdLastChange]) VALUES (4, N'Team4', CAST(N'2021-07-09T09:27:43.217' AS DateTime), 2, CAST(N'2021-07-09T09:27:43.217' AS DateTime), 2)
GO
INSERT [dbo].[Team] ([Id], [Title], [DateOfCreation], [IdCreator], [DateLastChange], [IdLastChange]) VALUES (5, N'Team5', CAST(N'2021-07-12T15:33:50.497' AS DateTime), 3, CAST(N'2021-07-12T15:33:50.497' AS DateTime), 3)
GO
SET IDENTITY_INSERT [dbo].[Team] OFF
GO
SET IDENTITY_INSERT [dbo].[User] ON 
GO
INSERT [dbo].[User] ([Id], [Username], [Password], [FirstName], [LastName], [DateOfCreation], [IdOfCreator], [DateLastChange], [IdLastChange], [isAdmin]) VALUES (1, N'admin', N'adminpass', N'admin', N'admin', CAST(N'2021-07-07T10:51:24.250' AS DateTime), NULL, CAST(N'2021-07-08T16:12:10.167' AS DateTime), NULL, 1)
GO
...
GO
INSERT [dbo].[User] ([Id], [Username], [Password], [FirstName], [LastName], [DateOfCreation], [IdOfCreator], [DateLastChange], [IdLastChange], [isAdmin]) VALUES (1009, N'user7', N'userpass7', N'user7', N'user7', CAST(N'2021-07-12T15:31:34.147' AS DateTime), 2, CAST(N'2021-07-12T15:31:34.147' AS DateTime), 2, 0)
GO
SET IDENTITY_INSERT [dbo].[User] OFF
GO
SET IDENTITY_INSERT [dbo].[WorkLog] ON 
GO
INSERT [dbo].[WorkLog] ([Id], [IdTask], [IdUser], [Time], [Date]) VALUES (2, 2, 2, N'3', N'Jul  8 2021  3:14PM')
GO
INSERT [dbo].[WorkLog] ([Id], [IdTask], [IdUser], [Time], [Date]) VALUES (3, 2, 3, N'2', N'Jul  9 2021 10:09AM')
GO
INSERT [dbo].[WorkLog] ([Id], [IdTask], [IdUser], [Time], [Date]) VALUES (4, 3, 4, N'1', N'Jul  9 2021 10:11AM')
GO
